...
import 'package:lgs_audiopedia/data/pashto_data/lg_data_pashto.dart';
...
class TopicsLGPashto extends StatefulWidget {
  ...
  @override
  _TopicsLGPashtoState createState() => _TopicsLGPashtoState();
}

class _TopicsLGPashtoState extends State<TopicsLGPashto> {
  List<Topic>? topics;
  String query = '';

  List<Topic> topicData = List.generate(
    allTopicsLgPashto.length,
    (index) => Topic(
        id: allTopicsLgPashto[index].id,
        title: allTopicsLgPashto[index].title,
        description: allTopicsLgPashto[index].description),
  );
  @override
  void initState() {
    super.initState();
    // topics = allTopics;
    topicData = allTopicsLgPashto;
  }

  void searchBook(String query) {
    final books = allTopicsLgPashto.where((book) {
