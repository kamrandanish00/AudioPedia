...
final allTopics = <Topic>[
  ...
  Topic(
      ...
      description:
          ...
          '•	Tiredness'
          'Moderate symptoms:'
          'o	Inflammation of lungs is a condition in which the thin layers of tissue that separate lungs from chest wall — becomes inflamed'
          'o	Mild pneumonia is a condition which chest pain, breathe or cough occurs in a patient. '
          'o	Fever, cough'
  ...
  Topic(
      ...
      description:
          '•	Viral test which is done for patient currently infected with Covid virus.'
          '•	Antibody test done for people who were infected with virus in the past.'),
  Topic(
      id: 8,
      title: 'Things to Do After Getting a COVID-19 Test	7',
  ...
  Topic(
      ...
      description: 'Contact tracing works best when you protect yourself.'
  ...
  Topic(
      ...
      description:
          '1st Dose: Citizens to register themselves by sending NIC no to 1166 from any mobile number or visit nims.nadra.gov.pk. An automatic message is received from 1166 with direction to report to any particular vaccination center for administration of 1st dose of vaccine.'
          '2nd Dose: For 2nd dose message is sent to the citizens automatically 48/24 hours before the due date from 1166'),
  Topic(
      id: 15,
      title: 'Types of vaccination',
      description:
  ...
  Topic(
      ...
      description:
          ...
          'Various myths are associated with administration of Covid vaccine such as in fertility , fixing of chip in body creating a panic among general public which was previously hampering vaccination process to a greater extend . Now that Covid 19 vaccines have reached billions of people worldwide including Pakistan, the evidence of success is overwhelming that vaccines offer life-saving protection against a disease that has killed millions. Moreover, any possible risks that may exist are considerably lower than those associated with COVID-19 infection, and vastly outweighed by the benefits of protecting people and preventing the virus from spreading.'),
  Topic(
      id: 18,
      title: 'Overall myths about COVID',
      description:
          'Myths are quite common in regard to various diseases from time to time taking a long way to demystify most of these myths through evidence based research. In recent times, some of the common infections, which are associated with myths, include Leprosy, Tuberculosis, and Flu (CDC, 2018; Haldimand-Norfolk Health and Social Sciences, 2018; World Health Organization, 2019).'
          ...
          '6.	Using cow dung and cow’s urine can cure the virus'
          '7.	Hand sanitizers are better than soap and water'
          '8.	Anti-bacterial drugs are effective for therapy of Covid-19'),
  Topic(
      id: 13,
