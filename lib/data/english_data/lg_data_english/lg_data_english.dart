...
final lgDataEnglish = <Topic>[
  ...
  Topic(
      id: 6,
      title: 'Process of KP-FATA Merger',
      description:
  ...
  Topic(
      ...
      description:
          ...
          'After the merger there is no difference between legal, administrative, and political system in the Merged Areas of Khyber Pakhtunkhwa and the rest of Pakistan now.\n\n',
      audioUrl: 'audiourl'),
  Topic(
      id: 8,
      title: 'Extension of Departments/Commissions',
      description:
          'Before merger a basic infrastructure in term of institutional framework was in place in FATA since Political Agent was the head of the agency responsible for everything including law and order, dispensation of justice and socio-economic development of their areas.\n\n'
  ...
  Topic(
      id: 9,
      title: 'Public Role in the New LG System',
      description:
          '•	The role of public in the new system established in the Merged Areas is of paramount importance and it is incomplete without their proactive participation for strengthening local governance. Service provision arrangements are always linked to various forms of community participation for improving the outcomes. Other aspect of community participation is public sector accountability at local, regional, and national levels. \n\n'
          ...
          '•	Another very important role of public is to participate through civil society forum such as Community Based Organization, and Civil Society Organizations to help government departments in achieving development outcomes and objectives. \n\n'
  ...
  Topic(
      id: 10,
      title: 'What is Local Government System',
      description:
          'Pakistan is a federal republic with three tiers of government: national, provincial, and local. Local government is protected by the 1973 constitution of Pakistan and each province has its own local government system and implementation framework.\n\n'
          'Local government is the third tier of a government structure and offers grass-root development to the community and a sense of involvement and ownership in the decision making process.',
      audioUrl: 'audio'),
  Topic(
      id: 11,
      ...
      description:
          ...
          'The active history of local government in Pakistan started with introduction of Basic Democracy System in 1959 by General Ayub Khan. \n',
      audioUrl: 'audio'),
  Topic(
      id: 12,
  ...
  Topic(
      id: 14,
      title: 'Local Government Ordinance 2001',
      description:
  ...
  Topic(
      ...
      description:
          'The Government of Khyber Pakhtunkhwa, due to policy shift, decided to make amendment in the Local Government Act 2013 knows as Local Government Amendment Act 2019. Comparative analysis of Local Government Act 2013 and Local Government Amendment Act 2019 are as under with some of the key features:\n\n'
  ...
  Topic(
      ...
      description:
          'The local government is established for carrying out development activities at local level and provision of basic service delivery to the citizens through an elected system operated at local level as per mandated functions in the Local Government Amendment Act 2019. For any effective local government, sufficient autonomy in political, administrative, and financial matters is must and for its existence. \n\n'
  ...
  Topic(
      id: 25,
      title: 'Functions of Chairman Village Council/Neighbourhood Council',
      description:
  ...
  Topic(
      ...
      description:
          ...
          '•	Any other task assigned by Assistant Director, Local Government or Provincial Government. \n\n',
      audioUrl: 'audio'),
  Topic(
      id: 29,
      title: 'Definitions',
  ...
  Topic(
      ...
      description:
          ...
          'In either case, it the primary responsibility of communities to dump solid waste at specific point and specific time for onward disposal by respective staff of TMA. Without their proactive role, proper cleanliness and collection of solid waste is next to impossible for the staff of VC/NC and TMAs.\n\n'
          'Streetlights: \nVC/NC and TMAs provide installation of streetlights to their respective residents for safety and security. Any resident in respective area may submit formal application to VC/NC or TMA for installation of streetlight or replacement of bulb or electricity pole as required. In case of any theft or accident, the matter should be immediately reported to respective VC/NC or TMA for punitive action against the culprits.\n\n'
  ...
  Topic(
      ...
      description:
          ...
          'Youth: \na duly qualified candidate for election who is below 30 years of age under the act.\n\n'
          'Woman: \na female registered in the electoral list of the area. Local government system encourages women to participate in the decision making as well as elections.\n\n'
          'Peasant:  \npeasant means a person who is a landless farm worker, or one who during the period of five years preceding the year in which elections is held, has been the owner of not more than five acres of land and depends directly on it for substantive living.\n\n'
          'Worker: \na means a person directly engages in work or is dependent on personal labor or substantive living or includes a worker as defined in the Khyber Pakhtunkhwa industrial relation act, 2010.\n\n'
          'Minority: \nA minority means non-Muslim registered voter in the respective area.\n\n'
  ...
  Topic(
      ...
      description: 'Composition of the Local Government Commission:\n'
  ...
  Topic(
      ...
      description:
          ...
          'Deputy Commissioner (DC): \nThe Deputy Commissioner (DC) is responsible for the maintenance of law and order in the district. He is the head of administration and coordinates and ensures implementation of provincial government policies. DC was formerly called Political Agent in erstwhile FATA.\n\n'
  ...
  Topic(
      id: 40,
      title: 'Member Provincial Assembly (MPA)',
      description:
  ...
  Topic(
      id: 41,
      title: 'Member National Assembly (MNA)',
      description:
  ...
  Topic(
      ...
      description:
          ...
          'The list of 41 public services dully notified by provincial government is given below:\n\nhttps://kprts.gov.pk/index.php/welcome/display_notified',
      audioUrl: 'audio'),
  Topic(
      id: 46,
  ...
  Topic(
      id: 48,
      title: 'Accelerated Implementation Program (AIP) 2019-2023',
      description:
